...
e.popup.template = {
  None:       			'pPopupBase',
  NoButton:   			'pPopupNoButton',
  Close:     			  'pPopupClose',
  Ok :      		   	'pPopupOk',
  YesNo:     				'pPopupYesNo',
  OkCancel:    			'pPopupOkCancel',
  OkCancelOther: 		'pPopupOkCancelOther',
  FormSubmit: 			'pPopupFormSubmit',
  Tooltip: 					'pPopupTooltip',
  TooltipAlert:			'pPopupTooltipAlert',
  AppBar: 					'pPopupAppBar',
  Maps: 						'pPopupMaps'
}
