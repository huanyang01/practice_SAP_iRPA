...
<ConteXtorStudio Version="Desktop Studio 2.0.0.173" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="XsdStudio.xsd">
	...
	<PROCESSUS>
		<PROCESS Name="GLOBAL" Key="NoKey" Comment="Global Processus" CtxtId="5564f25f-064c-4d86-8557-c87c2b032935">
			...
			<SCRIPTS>
				...
				<SCRIPT Name="Declarations" Src="00.helloworld.resources.js" ReadOnly="Y" />
				<SCRIPT Name="Labels" Src="labels.js" />
				<SCRIPT Name="Global" Src="global.js" />
				<SCRIPT Name="HelloWorldFlow" Src="helloworldflow.js" IsWorkflowGenerated="Y" />
			</SCRIPTS>
			<RESOURCES>
			...
			<_ECRANS />
			<WORKFLOWS>
				<WORKFLOW Name="HelloWorldFlow" Src="%workflows%\HelloWorldFlow.xaml" CtxtId="95837d18-f39d-48ab-8f4d-5874fa8c9f94" DisplayName="HelloWorldFlow" StepTimeout="30" ScenarioTimeout="600" GeneratedScenarioName="HelloWorldFlow" />
			</WORKFLOWS>
			<ACTIONS />
			<EVENTS />
			<SCENARII>
	...
	<APPLICATIONS />
	<CONTEXT Id="79484c8c-ca30-47b6-a862-f0daeb8e0269" />
</ConteXtorStudio>