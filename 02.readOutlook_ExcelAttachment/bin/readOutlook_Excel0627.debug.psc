...
<ConteXtorStudio Version="Desktop Studio 2.0.1.49" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" noNamespaceSchemaLocation="XsdStudio.xsd">
	<UpdatePackages />
	<Evolutions>
		<Evolution Version="1.0" Date="6/27/2020"><![CDATA[Project creation]]></Evolution>
		<Evolution Version="..." Date="..."><![CDATA[...]]></Evolution>
	</Evolutions>
	<PROCESSUS>
		<PROCESS Name="GLOBAL" Key="NoKey" Comment="Global Processus" CtxtId="f648a08b-4b33-4fda-9733-a338c4f19177">
			<_DECLAREVAR>
				<STRUCTUREDON Name="GLOBAL">
					<OBJDON Name="PrjVersion">1.0</OBJDON>
					<OBJDON Name="PrjClient"><![CDATA[SAP]]></OBJDON>
					<OBJDON Name="PrjName">02.readOutlook_ExcelAttachment</OBJDON>
					<OBJDON Name="PrjDate">27/06/2020</OBJDON>
					<OBJDON Name="PrjLabel"><![CDATA[02.readOutlook_ExcelAttachment]]></OBJDON>
					<OBJDON Name="PrjComment"><![CDATA[readOutlook_ExcelAttachment]]></OBJDON>
			...
			<SCRIPTS>
				...
				<SCRIPT Name="Declarations" Src="readoutlook_excel0627.resources.js" ReadOnly="Y" />
				<SCRIPT Name="Labels" Src="labels.js" />
				<SCRIPT Name="Global" Src="global.js" />
				<SCRIPT Name="readOutlook_Excel" Src="readoutlook_excel.js" IsWorkflowGenerated="Y" />
			</SCRIPTS>
			<RESOURCES>
			...
			<_ECRANS />
			<WORKFLOWS>
				<WORKFLOW Name="readOutlook_Excel" Src="%workflows%\readOutlook_Excel.xaml" CtxtId="b80df867-ea2a-45e1-baab-cd175c580e93" DisplayName="readOutlook_Excel" StepTimeout="30" ScenarioTimeout="600" GeneratedScenarioName="readOutlook_Excel" />
			</WORKFLOWS>
			<ACTIONS />
			<EVENTS />
			<SCENARII>
		...
		<PROCESS Name="POPUPS" CtxtId="38f591aa-af6a-4b39-b1d0-8797416933a9" Nature="POPUP">
			<SCRIPTS />
			<SCENARII>
				<Steps />
			</SCENARII>
	...
	<APPLICATIONS />
	<CONTEXT Id="09eeda1c-9cf7-4424-ae6f-a868e50a85c0" />
</ConteXtorStudio>